...
if __name__ == '__main__':
    ...
    ## TODO compute number of contacts between binder and peptide, and number of contacts between binder and MHC


    ## compute design consistency metrics if running on the original target used for diffusion design
    if not args.run_alt_target:
        ...
        for folding_name, designed_structure in tqdm(name_to_designed_structure.items()):
            ...
            ref_rmsd = refolding_rmsd(designed_structure, folded_structure, list(cfg.chain_to_template_path.keys()), [cfg.designed_chain]) ## TODO this might be wrong...
